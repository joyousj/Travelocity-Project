...
<body>
	<div id="main">
		<!-- <div id="header"> -->
			<div id="logo">
				<div id="logo_text">
					...
					<h1>
						<a href="/webapp/">Error! Your Request is Invalid!<span class="logo_colour"></span></a>
					</h1>
					<h2></h2>
				</div>
			</div>
		...
		<div id="site_content">
			...
			<div id="content">
				<h1>PLease<a href="/webapp/login">Login</a>or<a href="/webapp/register">Register</a></h1>
			</div>
		</div>
